...
class System extends PluginBase implements Listener {
	...
	if($command->getName() === "fw") {
            ...
            $sender->teleport(new Vector3($x, $y, $z), $yaw, $pitch, $level);
            ...
            if(!empty($args[0])){
                if(strtolower($args[0]) == "help"){
                    if($sender->isOp()){
                        ...
                        $sender->sendMessage("§b /setspawn farmwelt");
                        $sender->sendMessage("§b /setspawn citybuild");
                    }
                    $sender->sendMessage("§7====================");
                } elseif(strtolower($args[0]) == "farmwelt" && $sender->isOp()){
                    if($sender instanceof Player){
                    ...
                    } elseif(strtolower($args[0]) == "citybuild" && $sender->isOp()){
                    if($sender instanceof Player){
